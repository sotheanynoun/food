                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5 text-center">
                                        <a href="index.html" class="d-block auth-logo">
                                            <img src="{{ asset('backend/assets/images/logo-sm.svg') }}" alt="" height="28"> <span class="logo-txt">EasyLearning</span>
                                        </a>
                                    </div>
...
<form action="{{ route('admin.password_submit') }}" method="post" class="mt-4 pt-2" action="index.html">
@csrf
    <div class="mb-3">
