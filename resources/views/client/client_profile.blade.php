...
<div class="row">
    <div class="col-lg-6">
        <div>
            ...
            <div class="mb-3">
                <label for="example-text-input" class="form-label">Restuarant Info</label>
                <textarea name="shop_info" id="basicpill-address-input" rows="2" class="form-control" placeholder="Enter your Address">{{ $profileData->shop_info }}</textarea>
            </div>
            <div class="mb-3">
    ...
    <div class="col-lg-6">
        <div class="mt-3 mt-lg-0">
            ...
            <div class="mb-3">
                <label for="example-date-input" class="form-label">Profie Image</label>
